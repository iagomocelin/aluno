 ...
 */
public class ListagemAluno extends javax.swing.JDialog {

    /**
     * Creates new form ListagemAluno
     */
    public ListagemAluno(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ControladorAluno.atualizarTabela(tabela);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ListagemAluno dialog = new ListagemAluno(new javax.swing.JFrame(), true);
